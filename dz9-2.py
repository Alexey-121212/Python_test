...
# max_households_in_min_population = df['households'][(df['median_house_value'] == df['median_house_value'].max())].min()
# print(max_households_in_min_population)

a = df['households'][(df['median_house_value'] == df['median_house_value'].max())].min()
print(a)